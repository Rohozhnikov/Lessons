...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LambdaLibrary.pr6.apply(testItem6, 55000, 120000));
		...
		System.out.println(LambdaLibrary.pr7.apply(testItem7));
	        
		System.out.println("\nQuery 8");
		// Find all traders from Cambridge and sort them by name.
		List<Transaction> testItem8 = testItem7;  
		System.out.println(LambdaLibrary.pr8.apply(testItem8));
